...
class App extends Component {
  render() {
    ...
    <div id="ember456" className="ember-view"><div style={{height: '0px'}} id="ember461" className="notification collapsible collapsed ember-view"></div></div>
...
<a href="/signup" id="ember551" className="header__signup-button ember-view">        Créer un compte
  ...
  <div className="application__body-container">
    <div className="application__body">
      <div id="ember597" className="open-home__header ember-view"><h1 className="open-home__title">Réservez vos billets de train et de bus. <br/>En France et en Europe.</h1>
...
<div style={{height: '554px'}} id="ember598" className="search__form--collapsible collapsible slow fade ember-view">  <div style={{'overflow': 'hidden'}} className="collapsible__measuring-div">
            <div data-help-contexts="tab_search" id="ember603" className="search__form ember-view"><div className="search__form--left split-panel--left
        ">
  ...
  {/* <form>
    <div className="search__section search__section--od">
      <div className="search__field
               ...
               awaiting-input
               focus">
        <input tabIndex="1" type="text" autocomplete="off" spellcheck="false" required="" placeholder="Saisissez votre gare de départ…" id="ember669" className="search__departure-input ember-text-field textfield station-text-field empty station-text-field-- search__input focus empty ember-view"/>
      </div>
      ...
      <div className="search__field
               ...
               awaiting-input
               ">
        <input tabIndex="1" type="text" autocomplete="off" spellcheck="false" required="" placeholder="Saisissez votre gare d’arrivée…" id="ember674" className="search__arrival-input ember-text-field textfield station-text-field empty station-text-field-- search__input empty ember-view"/>
      </div>

      <button id="ember677" style={{display: 'none'}} className="search__swap swap-button swap-button--in-between ember-view"><div className="swap-button__equilibrium">
  <span className="swap-button__label">Échanger les gares de départ et d’arrivée</span>
    ...
    <div className="search__section search__section--date">
      <div className="search__field
                  ...
                  ">
        <input tabIndex="1" type="button" value="" id="ember683" className="search__departure-date-input search__input empty ember-view"/><div className="ct-placeholder" style={{'color': 'rgb(169, 169, 169)', 'position': 'absolute', 'z-index': 2, 'user-select': 'none', 'line-height': '20px', 'left': '36px', 'marginTop': '-30px'}}>Aller</div>

        <div id="ember686" className="search__accessory empty ember-view"><span className="search__accessory-prefix">
  à partir de
</span>
        ...
        <div className="search__field
                    ...
                    grouped-input--bottom
                    ">
          <input tabIndex="1" type="button" value="" id="ember687" className="search__return-date-input search__input empty ember-view"/><div className="ct-placeholder" style={{'color': 'rgb(169, 169, 169)', 'position': 'absolute', 'z-index': 2, 'user-select': 'none', 'line-height': '20px', 'left': '36px', 'marginTop': '-30px'}}>Retour</div>

          <div id="ember688" className="search__accessory empty ember-view"><span className="search__accessory-prefix">
  à partir de
</span>
    ...
    <div className="search__section search__section--participants">
      <div className="search__field
               ...
               ">
        <input tabIndex="1" type="button" value="1 Adulte (26 - 59)" id="ember693" className="search__participants-input passengers-field passengers-field__passengers--1 search__input ember-view"/><div className="ct-placeholder" style={{'color': 'rgb(169, 169, 169)', 'position': 'absolute', 'z-index': 2, 'user-select': 'none', 'line-height': '20px', 'left': '36px', 'marginTop': '-30px', 'display': 'none'}}>Passagers</div>

          <button type="button" className="search__add-participants" data-ember-action="" data-ember-action-694="694">
      ...
      <a className="search__add-cui" data-ember-action="" data-ember-action-695="695">Utiliser un code de réduction</a>

<div id="ember698" className="search__button progress-button ember-view"><button type="button" tabIndex="1" className="button progress-button__button">
        Rechercher
...
{/*Les petits plus de train line a integrer avant le clic*/}
  ...
  <div id="ember717" className="ember-view">  <div id="ember726" className="mobile-incentive generic ember-view"><div className="mobile-incentive__wrapper">
...
<section className="open-home__main">
  <article className="open-home__carriers">
    <div id="ember732" className="ember-view"><div className="open-home-carriers__title--container open-home__content">
...
<div className="open-home-carriers__logos">
  ...
  <article className="open-home__bus-teaser">
    ...
    <article className="open-home__testimonials">
      ...
      <div id="ember769" className="ember-view"><div className="open-home__tweets--container open-home__content">
...
<div style={{'height': '0px'}} id="ember774" className="collapsible collapsed slow ember-view"></div>  <a href="" className="tweets__load-more " data-ember-action="" data-ember-action-775="775">
    Plus d’amour…
  </a>
</div>
</div>
  ...
  <div id="ember792" className="ember-view">  <div id="ember797" className="ember-view"><footer className="tle tle-footer">
  ...
  <div style={{'':''}} id="ember831" className="currency-switcher-overlay currency-switcher-overlay--hidden ember-view"><div id="ember836" className="currency-switcher ember-view">
...
<button className="currency-switcher-overlay__close">Cancel</button>
  ...
  <div id="ember898" className="country-picker-overlay country-picker-overlay--hidden ember-view"><h2 className="country-picker-overlay__title">Sélectionnez votre pays</h2>

<div id="ember903" className="country-picker ember-view">  <div className="country-picker__region country-picker__regions--multiples">
...
</div>  <div id="ember-basic-dropdown-content-ember943" style={{'display': 'none'}} className="ember-basic-dropdown-content-placeholder"></div>
